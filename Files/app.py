...
def main():
    ...
    output_filename = os.path.join(output_folder, "All_Emad_Sub.txt")
    filename1 = os.path.join(output_folder, "All_Emad_base64_Sub.txt")
    ...
    for i in range(20):
        filename = os.path.join(output_folder, f"Emad Sub{i}.txt")
        if os.path.exists(filename):
            os.remove(filename)
        filename1 = os.path.join(base64_folder, f"Emad Sub{i}_base64.txt")
        if os.path.exists(filename1):
            os.remove(filename1)
...
"""
        ...
        input_filename = os.path.join(output_folder, f"Emad Sub{i + 1}.txt")
        ...
        output_filename = os.path.join(base64_folder, f"Emad Sub{i + 1}_base64.txt")
